...
#ifndef __Hydrofem_Triangle_Dunavant_HPP__
#define __Hydrofem_Triangle_Dunavant_HPP__

namespace hydrofem
{

namespace TriangleDunavant
{
...
// end namespace TriangleDunavant

}
// end namespace hydrofem

#endif /** __Hydrofem_Triangle_Dunavant_HPP__ */
